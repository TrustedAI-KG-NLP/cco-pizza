...
- **Does the term already exist?** Before submitting suggestions for new ontology terms, check whether the term exist, either as a primary term or a synonym term. You can search using [OLS](http://www.ebi.ac.uk/ols/ontologies/pizza)
...
On behalf of the Pizza Manufacturing Ontology based on Common-Core Ontology editorial team, Thanks!